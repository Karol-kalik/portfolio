          ...
          <section className="frontPage">
            <div className="info">
              ...
              <p className={addClassP}>
                Nazywam się Karol, mam 20 lat. Programowania zacząłem się uczyć
                na początku kwietnia 2020 roku, stało się to moją pasją. Od
                października rozpoczynam studia na kierunku informatycznym.
                Staram się codziennie uczyć czegoś nowego i rozwiązywać
                napotkane mnie problemy. Jestem osobą kreatywną i lubiącą
                pracować w zespole. Z chęcią uczę się od innych w celu nabycia
                nowej wiedzy i nie popełniania tych samych błędów.
              </p>
            </div>
            <div className="info">
              ...
              <p className={addClassP}>
                Moim planem na najbliższe late jest dalszy rozwój. Chce się
                uczyć coraz to nowszych technologii, nie opierać się na jednej.
            ...
            <div className="info last">
              ...
              <p className={addClassP}>
                Tylko ciężką pracą można coś w życiu osiągnąć. Moim marzeniem
                jest znaleźć pracę, która da mi możliwość rozwoju zawodowego.
                Jestem pewny, że moją wytrwałością jestem w stanie dużo
                osiągnąć, żeby stać się lepszy. Mam nadzieje, że ten czas który
                wykorzystuje na kształcenie zaowocuje
