...
const PortfolioPageTwo = () => {
  const fireEmoji = (
    <span role="img" aria-label="fire" className="fireEmoji">
      🔥
    </span>
  );
  ...
  $(window).on("scroll", function () {
    ...
    if ($(".portfolioPartTwo").length > 0) {
      const offsetSlierToo = $(".portfolioPartTwo").offset().top;
      const heightSlider = $(".portfolioPartTwo").outerHeight();
      if (scrollPosition > (offsetSlierToo + heightSlider - windowHeight) / 2) {
        $(".portfolioItem").addClass("move");
      }
    }
  });
  ...
  return (
    <>
      <div className="portfolioPartTwo">
        <div className="portfolioItem">
          <a
            href="https://karol-kalik.github.io/portfolio/#/"
            target="_blank"
          ...
          >
            ...
            <div className="titleBox">
              <span>
                {fireEmoji} Portfolio {fireEmoji}
              </span>
            </div>
            <p className="imgInfo">
              Moje portfolio jest to najbardziej rozbudowany projekt jaki
              stworzyłem. Strona jest stworzona przy pomocy React'a
            </p>
        ...
        <div className="portfolioItem">
          <a
            href="https://karol-kalik.github.io/skateboardMaker/"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="portfolioItem">
          <a
            href="https://karol-kalik.github.io/ToDoList/"
            target="_blank"
            rel="noopener noreferrer"
          >
